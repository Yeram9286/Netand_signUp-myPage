  ...
  <div className={styles.wrapper}>
    <div className={styles.inputGroup}>
      ...
      <div className={styles.inputBox}>
        ...
        <button className={styles.imageBtn} type="button" />
      </div>
    ...
    <div className={styles.inputGroup2}>
      ...
      <div className={styles.inputBox2}>
        ...
        <input type ="text" placeholder="이름"/>
         ...
         <div className={styles.inputBox2}>
        <img src={phone} alt="이름" className={styles.icon_phone}/>
...
/>
 ...
 <div className={styles.dropdownContainer}>
  <div className={styles.dropdownHeader} onClick={() => setDropdownOpen(prev => !prev)}>
    <img src={building} alt="회사구분" className={styles.icon_building} />
    <span className={styles.label}>{companyType || '회사 구분'}</span>
